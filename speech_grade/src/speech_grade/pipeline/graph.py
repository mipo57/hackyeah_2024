...
def step_analyze_speech_volume(state: State) -> State:
    high_volume_words, low_volume_words = analyze_speech_volume(state["audio_path"], state["transcription_words"])
...
def step_calculate_speech_speed(state: State) -> State:
    ...
    avg_words_per_minute, words_per_minute, wpm_timestamps = speech_speed(state["transcription_words"])
...
def build_graph():
    ...
    graph_builder.add_edge("step_detect_audio_problems", END)
    ...
    graph_builder.add_edge("step_gather_images", END)

    graph_builder.add_edge("step_transcribe_audio", "step_analyze_speech_volume")
    graph_builder.add_edge("step_analyze_speech_volume", END)
    ...
    graph_builder.add_edge("step_add_clarity_score", END)
    ...
    graph_builder.add_edge("step_calculate_speech_speed", END)
