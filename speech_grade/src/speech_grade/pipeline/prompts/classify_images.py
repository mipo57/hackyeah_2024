...
def classify_image(image_path: str) -> List[Event]:
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "Your task is to analyze the image provided by user and see if there are any quality problems of the following categories:\n{classes}\n\nIf you don't see any problems of the mentioned types, set problems to empty list.\n{output_format}"),
        ("user", [
