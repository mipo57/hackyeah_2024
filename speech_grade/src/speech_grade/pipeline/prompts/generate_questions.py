...
def generate_questions(transcription_words: List[TranscriptionWord]) -> str:
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "Your task is to generate questions that listener could ask to the speaker based on the transcription. The questions must be in Polish and must be about something related to the content of the speech, but not answerable from the speech itself. Generate 10 questions.\n{output_format}"),
